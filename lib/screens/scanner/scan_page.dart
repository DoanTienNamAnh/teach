...
import 'package:demo/screens/scanner/detactor_view.dart';
import 'package:demo/screens/scanner/text_recognize_painter.dart';
...
class _TextRecognizerViewState extends State<TextRecognizerView> {
  ...
  void _getData() async {
    ...
    _apiClient.login(request: request);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomSheet: TextButton(onPressed: () {
        _getData();
